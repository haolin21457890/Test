...
public class CarService {
	...
	public Pager<Car> findPager(Integer pageno, Integer pagesize, String sort,
			String order, String name, Date beginDate, Date endDate) {
		Pager<Car> pager = new Pager<Car>();
		pager.setRows(carMapper.findPager(pageno, pagesize, sort, order, name,
				beginDate, endDate));
